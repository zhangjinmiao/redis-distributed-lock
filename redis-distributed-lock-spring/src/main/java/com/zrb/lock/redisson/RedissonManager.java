package com.zrb.lock.redisson;

import com.zrb.lock.redisson.config.RedissonProperties;
import com.zrb.lock.redisson.config.strategy.ClusterRedissonConfigStrategyImpl;
import com.zrb.lock.redisson.config.strategy.MasterslaveRedissonConfigStrategyImpl;
import com.zrb.lock.redisson.config.strategy.RedissonConfigContext;
import com.zrb.lock.redisson.config.strategy.SentinelRedissonConfigStrategyImpl;
import com.zrb.lock.redisson.config.strategy.StandaloneRedissonConfigStrategyImpl;
import com.zrb.lock.redisson.constant.RedisConnectionType;
...
public class RedissonManager {
  ...
  static class RedissonConfigFactory {
    ...
    Config createConfig(RedissonProperties redissonProperties) {
      ...
      Preconditions
          .checkNotNull(redissonProperties.getType(), "redisson.lock.server.password cannot be NULL");
